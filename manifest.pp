class { 'ffnord::params':
  router_id => "10.187.120.1",  # The id of this router, probably the ipv4 address
...
ffnord::mesh { 'mesh_ffnord':
  ...
  , dhcp_ranges => ['10.187.120.2 10.187.122.254'] 
  , dns_servers => ['10.187.120.1']               # should be the same as $router_id
}
